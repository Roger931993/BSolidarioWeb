...
import { LayoutState, initialState } from '@web/store/layouts/layouts.reducer';
import { Store } from '@ngrx/store';
import {
  changeLayoutWidth,
  changeMode,
  changeSidebarMode,
} from '@web/store/layouts/layout.actions';
import {
  getLayoutMode,
  getLayoutWidth,
  getsidebar,
} from '@web/store/layouts/layout.selector';
import { RootReducerState } from '@web/store';
import { changesLayout } from '@web/store/layouts/layout.actions';
